...
export interface Deck { id:string;title:string;description:string;question_label:string;answer_label:string }
export interface CatalogSection {id:string;deck:Deck;count:number;steps:{key:string;id:number;items:number}[]}
