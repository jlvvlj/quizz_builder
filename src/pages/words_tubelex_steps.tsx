...
// Steps within a TUBELEX words frequency section. Reuses the words StepsPage
// with content='words_tubelex'. The last section is partial, so the real step
// count is derived from the word total instead of always being 10.
export default function WordsTubelexSteps() {
