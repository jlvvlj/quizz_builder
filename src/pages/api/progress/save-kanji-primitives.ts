...
type Stage = 'parse_request' | 'primitive_progress_upsert' | 'activity_read' | 'activity_upsert';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        stage = 'primitive_progress_upsert';
        ...
        console.error(`Error saving kanji primitive progress at stage="${failedStage}":`, error);
