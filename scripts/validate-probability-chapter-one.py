...
print('PASS: 27 lessons including 5 introductions, 13 original cards, all 16 figures, all 30 examples, %d intact excerpts; no clipped glyphs or orphan assets.'%len(seen))
