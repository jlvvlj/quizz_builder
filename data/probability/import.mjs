...
const {error}=await db.from('learning_decks').upsert({id:deck,title:'Probability · Sample Space and Probability',description:'Learn probability notation, sample spaces, events, probability models, conditioning, Bayes’ rule, independence, reliability and counting.',question_label:'Question',answer_label:'Answer',question_format:'multiple_choice'});
